    ...
    <div className="space-y-6">
      ...
      {tab === 'history' && (
        <div className="space-y-4">
          ...
          {entries.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-lg border"><Clock className="h-12 w-12 text-gray-300 mx-auto mb-4" /><p className="text-gray-500">{t('timeTracking.noEntries', 'No time entries found')}</p></div>
          ) : (
            <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
